  ...
  const videos = [
    {
      ...
      icon: <Building2 className="w-8 h-8 text-slate-600 mb-2" />,
    ...
    },
    {
      ...
      icon: <Briefcase className="w-8 h-8 text-slate-600 mb-2" />,
    ...
    },
    {
      ...
      icon: <BrainCircuit className="w-8 h-8 text-slate-600 mb-2" />,
    ...
    },
    {
      ...
      icon: <Bot className="w-8 h-8 text-slate-600 mb-2" />,
    ...
    },
    {
      ...
      icon: <Network className="w-8 h-8 text-slate-600 mb-2" />,
    ...
    },
    {
      ...
      icon: <Search className="w-8 h-8 text-slate-600 mb-2" />,
    ...
    },
    {
      ...
      icon: <Users className="w-8 h-8 text-slate-600 mb-2" />,
